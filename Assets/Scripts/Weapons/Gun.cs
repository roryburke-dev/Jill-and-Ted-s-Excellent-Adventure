...
public class Gun : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        fireRateTimeStamp = player.weaponType.bulletType.fireRate;
    }
    ...
    void Shoot() 
    {
        ...
        {
            if (fireRateTimeStamp > player.weaponType.bulletType.fireRate)
            {
                ...
                bulletInstance.SetValuesFromScriptableObject(player.weaponType.bulletType);
