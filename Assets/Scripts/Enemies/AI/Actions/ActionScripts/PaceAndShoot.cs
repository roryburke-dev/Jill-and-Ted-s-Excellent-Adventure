...
public class PaceAndShoot : Action
{
    ...
    public void Start()
    {
        ...
        fireRateTimeStamp = enemy.weapon.bulletType.fireRate;
    ...
    void Shoot()
    {
        ...
        if (fireRateTimeStamp > enemy.weapon.bulletType.fireRate)
        {
            ...
            bulletInstance.SetValuesFromScriptableObject(enemy.weapon.bulletType);
            bulletInstance.SetDirection(FacingDirection.south);
            bulletInstance.damage = enemy.weapon.bulletType.damage;
            fireRateTimeStamp = 0.0f;
        }
    }
}
